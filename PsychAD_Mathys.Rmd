...
# PsychAD: all pairs
```{r all}
cellTypes = unique(tab.psychad$assay)[1:6]

grd = expand.grid(CT1 = cellTypes, CT2 = cellTypes)
...
CT = factor(unique(df$CT1))
df$i = factor(df$CT1, CT)
df$j = factor(df$CT2, CT)
