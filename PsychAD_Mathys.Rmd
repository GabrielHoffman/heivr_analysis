...
plotPair = function(psychad, mathys){
  pair = c(psychad = psychad, mathys = mathys)
  ...
  lim = max(abs(c(hobj.mle$x, hobj.mle$y)))
  lim = c(-lim, lim)
  plot(hobj.mle, xlab="logFC (PsychAD)", ylab="logFC (Mathys)", main=paste(psychad, '/', mathys), xlim=lim, ylim=lim)
  abline(0,1)
  abline(h=0, lty=3)
  abline(v=0, lty=3)  
}
