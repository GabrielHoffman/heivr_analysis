...
C = convertToMatrix(res.Mathys, "p.value") 
D = -log10(C)
lim = max(D)
ggcorrplot(D, method = "circle", hc.order = TRUE) + scale_fill_gradient(low="white", high="red3", name=bquote(-log[10]~P), limits=c(0, lim))
```
