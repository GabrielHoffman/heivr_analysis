...
nmax = 1000
ngenes = 10000
nvalues = c(5, seq(10, 40, by=5), seq(50, 100, by=10), seq(150, 200, by=10))
...
df = lapply( 1:nrow(df_param), function(i){
  ...
  df = run_simulation(nmax, ngenes, cor.target = df_param$cor.target[i], nvalues, hsq = df_param$hsq[i], nreps=200, BPPARAM=SnowParam(36))
