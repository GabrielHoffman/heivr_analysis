...
frac = c(seq(.02, .1, length.out=9), seq(.15, 1, length.out=10))

# coefTest = c('DxSCZ')
# frac = c(seq(.05, .1, length.out=3), seq(.15, 1, length.out=3))

df.ramp = lapply(coefTest, function(coef){
  get_rho_rampup(coef, frac, nreps=100, BPPARAM = SnowParam(12))
  })
